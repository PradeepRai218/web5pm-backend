...
export default function Index({ productData }) {
  ...
  let [path, setPath] = useState(productData.STATICPATH ?? "");
  ...
  return (
    <>
      <Container fluid className="p-0 banner">
        <Slider {...settings}>
          <img
            src="/648e23d4-5e5d-4fd0-b0f7-856ee45c6629-1671388137.jpg"
            alt="banner"
            className="img-fluid"
          />
          <img
            src="/541928cd-e696-4c09-9f1c-bc9d7127c451-1671388153.jpg"
            alt="banner"
            className="img-fluid"
          />
          <img
            src="/add8f1ce-ae5a-4d6b-b573-8c208b6745d5-1671388062.jpg"
            alt="banner"
            className="img-fluid"
          />
        </Slider>
            ...
            <Col xs={12}>
              <div className="product_area">
                ...
                <div className="tab-content">
                  <div
                    className={`tab-pane fade ${activeTab === "featured" ? "active show" : ""}`}
                    id="featured"
                    role="tabpanel"
                  >
                          ...
                          return (
                            <Col md={3} className="full-width">
                              ...
                              <Card className="single_product full-width">
                                 <Link href={`/product-details/${obj.slug}`}>
                                <Card.Img
                                  variant="top"
                                  src={path+obj.image}
                                />
              ...
              <div className="newsletter_content">
                ...
                <div className="subscribe_form">
                  <Form
                    ...
                    id="newsletter_form"
                    className="mc-form footer-newsletter bv-form"
                  >
