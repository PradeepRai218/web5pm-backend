...
export default function AddSubCategory() {
  ...
  let saveSubcategory=(e)=>{
    ...
    axios.post(`${apiBaseUrl}subcategory/add`,myData)
        .then((res)=>res.data)
       .then((finalRes)=>{
      ...
      <section className="w-full">
        ...
        <nav className="flex border-b bg-white px-6 py-3 shadow-sm">
          <ol className="inline-flex items-center space-x-2 text-gray-600">
            ...
            <li>/</li>
            <li>
              <a className="text-md font-medium">Sub Category</a>
            </li>
            <li>/</li>
              ...
              <div className="basis-[70%]">
                ...
                <div className="mb-6">
                  ...
                  <select
                    ...
                    id="default"
                    name="parentCategory"
                    className="text-[17px] border cursor-pointer border-gray-300 text-gray-900 rounded-lg focus:ring-gray-400 focus:border-gray-500 block w-full py-2.5 px-3"
                  >
