      ...
      <section className="w-full">
        ...
        <nav className="flex border-b-2 bg-white py-3 px-6" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-2">
            ...
            <li>/ <a className="text-md font-medium text-gray-700 hover:text-blue-600">Testimonial</a></li>
            <li>/ <span className="text-md font-medium text-gray-500">View Testimonials</span></li>
          </ol>
        </nav>
              ...
              <table className="w-full text-left text-gray-700">
                ...
                <tbody>
                  ...
                  <tr className="bg-white border-b">
                    ...
                    <td className="px-2 py-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum, nisi ipsum! Hic maxime sit doloribus quaerat sint quae amet at aliquam. Consequuntur beatae, vero id dolorem soluta ipsum consequatur quidem!</td>
                    <td className="px-2 py-4">1</td>
                    <td className="px-2 py-4">
